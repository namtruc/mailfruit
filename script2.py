...
while 1:
    reponse = input("\nTaper 1 pour choisir le fichier excel comportant les liens catalogue (ou les donnees a exporter) dans le repertoire actuel (recommande)\nTaper 2 pour choisir un autre repertoire\n")
    if reponse=='1':
        break
    elif reponse =='2':
...
print ("\n---Contenu du dossier---")
for x in range (len(newlist1)) :
	print (str(x)+" "+newlist1[x])


reponse = int(input("\nEntrer le numero (0, 1, 2...) correspondant au fichier voulu\n"))
contenu1 = newlist1[reponse]
...
while 1:
    reponse = input("\nTaper 1 pour choisir le fichier excel cible dans le repertoire actuel (recommande)\nTaper 2 pour choisir un autre repertoire\n")
    if reponse=='1':
        break
    elif reponse =='2':
        dossier = input("Entrer le chemin du dossier\n")
