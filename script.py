...
while 1:
    reponse = input("Taper 1 pour copier automatiquement les liens du tableur suivi-envoi sur la base de donnees clients\nTaper 2 pour passer cette etape\n")
    if reponse=='1':
        import script2
        break
    elif reponse =='2':
...
while 1:
    reponse = input("Taper 1 pour choisir le fichier HTML dans le repertoire ''fichier_utilisateur'' (recommande)\nTaper 2 pour choisir un autre repertoire\n")
    if reponse=='1':
        break
    elif reponse =='2':
...
for x in range (len(newlist)) :
	print (str(x)+" "+newlist[x])

reponse = int(input("\nEntrer le numero (0, 1, 2...) correspondant au fichier HTML contenant le texte brut du mail\n"))
contenu = newlist[reponse]
...
while 1:
	reponse = input("\nTaper 1 pour choisir les pieces jointes dans le repertoire actuel (recommande)\nTaper 2 pour choisir un autre repertoire\nTaper 3 si il n´y a pas de pieces jointes\n")
	if reponse=='1':
		break
	elif reponse =='2':
...
if l == 0 :
	...
	print ("\n---Contenu du dossier---")
	for x in range (len(newlist3)) :
		print (str(x)+" "+newlist3[x])

	for x in range (nbr_pj):
		reponse = int(input("\nEntrer le numero (0, 1, 2...) correspondant a la piece jointe numero "+str(x+1)+"\n"))
		e.append(newlist3[reponse])
...
while 1:
    reponse = input("\nTaper 1 pour choisir le fichier excel ou libreoffice dans le repertoire actuel (recommande)\nTaper 2 pour choisir un autre repertoire\n")
    if reponse=='1':
        break
    elif reponse =='2':
        dossier = input("Entrer le chemin du dossier\n")
...
print ("\n---Contenu du dossier---")
for x in range (len(newlist2)) :
	print (str(x)+" "+newlist2[x])


reponse = int(input("\nEntrer le numero (0, 1, 2...) correspondant au fichier voulu\n"))
contenu = newlist2[reponse]
